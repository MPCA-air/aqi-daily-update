...
# E-mail subscribers
subscribers <- "dkvale" #read_csv("data/daily_subscribers.csv")$git_name 
...
# Save web tables
# Ozone
verify_o3 <- formattable(filter(verify_all, pollutant == "Ozone")[ , c(1,7,8)],
                         list(Site        = margin_right(23),
                              #`Obs count` = margin_right(65),
                              Monitored   = col_mon_format(15, "ozone"),
                              `MPCA`      = col_format(15, "ozone")),
                          align = c("l","l","l"), digits = 1, format = "html")

#saveRDS(verify_o3, "o3_table.rdata")


# PM table
verify_pm <- formattable(filter(verify_all, pollutant == "PM2.5")[ , c(1,7,8)],
                         list(Site        = margin_right(23),
                              #`Obs count` = margin_right(65),
...
cat(".  \n\nView this weeks complete modeling performance at [AQI Watch](https://mpca-air.github.io/aqi-watch/). \n")
